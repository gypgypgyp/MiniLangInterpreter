...
/**
 * Implements the NotEquals operator.
 */
public class NotEqualsOperator extends AbstractPrimitive {

  /**
   * Applies the not-equals comparison operation to the provided list of arguments.
   * This method expects exactly two integer arguments and checks if they are not
   * equal to each other.
   ...
   * @return BooleanValue true if the two integers are not equal, BooleanValue false otherwise.
